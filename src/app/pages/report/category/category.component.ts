...
export const Illustrations = [
  { title: 'Vous avez rencontré un problème<br/>avec une entreprise&#160;?', picture: 'illustrations/consumer.svg' },
  { title: 'Faites un signalement<br/>avec SignalConso.', picture: 'illustrations/report.svg' },
  { title: `L'entreprise est prévenue<br/>et peut intervenir.`, picture: 'illustrations/company.svg' },
  { title: 'La répression des fraudes intervient<br/>si c’est nécessaire.', picture: 'illustrations/dgccrf.svg' },
];
