...
export class ReportedPhoneService {
  ...
  protected source = new BehaviorSubject<ReportedPhone[] | undefined>(undefined);
  ...
  readonly fetch = (q?: string, start?: Date, end?: Date): Observable<ReportedPhone[]> => {
  ...
  readonly extract = (q?: string, start?: Date, end?: Date): Observable<ReportedPhone[]> => {
    return from(
